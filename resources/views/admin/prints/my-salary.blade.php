...
<div class="employee-info">
    <div class="employee-details">
        <span>Mã Số NV: {{ $checkin->contract->user->employee_code }} </span>
    </div>
    <div class="employee-details">
        <span>Tên NV: {{ $checkin->contract->user->name }} </span>
    </div>
</div>
<div class="table-container">
    <table>
        ...
        <tr>
            ...
            <td colspan="1">{{ $checkin->total_salary }}
            </td>
        </tr>
        </tfoot>
    </table>
