...
@push('scripts')
    ...
    <x-change-status :url="route('admin.flash-sale.change-status')"></x-change-status>
    <x-change-status :url="route('admin.flash-sale.show-at-home.change-status')" selectorBtn=".change-at-home-status"></x-change-status>
