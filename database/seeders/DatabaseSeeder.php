...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        for ($i=0;$i<30;++$i)
        {
            ...
            (". $i+1 . ", 'Tri Ân Thầy Cô {$i}', 'tri-an-thay-co-{$i}', 'uploads/products/tri-an-thay-co.jpg', 1, 'Món quà ý nghĩa ngày nhà giáo', '<p>Khi mua trọn bộ &nbsp;<strong>Tri ân Thầy Cô</strong> Quý khách sẽ được<strong>&nbsp;Tặng kèm 1 phin nhôm nâu và 1 túi giấy đen</strong><br>
            ...
            DB::insert("
            INSERT INTO `products` (`id`, `name`, `slug`, `thumb_image`, `category_id`, `description`, `content`, `price`, `status`, `created_at`, `updated_at`) VALUES
            (". $i+31 . ", 'Bộ Quà Tặng Trung Nguyên Legend {$i}', 'bo-qua-tang-trung-nguyen-legend-{$i}', 'uploads/products/Hop-Qua-ABCD.jpg', 2, 'Món quà ý nghĩa ngày nhà giáo', '
            ...
            DB::insert("
            INSERT INTO `products` (`id`, `name`, `slug`, `thumb_image`, `category_id`, `description`, `content`, `price`, `status`, `created_at`, `updated_at`) VALUES
            (". $i+61 . ", 'Phin Nhôm Vĩ Nhân {$i}', 'phin-nhom-vi-nhan-{$i}', 'uploads/products/phin-nhom-vi-nhan.png', 3, 'Món quà ý nghĩa ngày nhà giáo', '<p>Thể tích đạt tiêu chuẩn của phin khoảng 170ml.</p>
